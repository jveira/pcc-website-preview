...
def gate_product_ux(pages, failures):
    ...
    required = {
        ...
        "earthquake-relief/index.html": ["id=\"donation-form\"", "donorbox-frame", "https://donorbox.org/widgets.js",
                                           ...
                                           'enable-auto-scroll="true"', "Colombia Earthquake Relief",
                                           "See how PCC and trusted local partners are supporting earthquake relief",
                                           "PCC earthquake response and long-term recovery in Colombia",
                                           'href="#donation-form" data-relief-form-link', "Donate to earthquake relief",
                                           "Our guiding principles", "Our response", "Alpha FC",
                                           "Cultura Viva via Fundación Ideamos", "Espíritu Indomable",
        ...
        "es/earthquake-relief/index.html": ["Respuesta al terremoto en Colombia",
                                              "Conoce cómo PCC y sus organizaciones aliadas están apoyando la emergencia",
                                              "Respuesta y recuperación tras el terremoto en Colombia",
